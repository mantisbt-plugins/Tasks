						...
						<div align="center">
							...
							while ($row = db_fetch_array($result)) {
								...
								<div align="center">
									...
									<td>
									<div align="center"><?php  echo html_entity_decode($row["taskcat_title"]); ?>
										</td><td>
										<div align="center">
											<a href="plugins/Tasks/pages/task_cat_delete.php?delete_id=<?php echo $row["taskcat_id"]; ?>"><?php echo lang_get( 'task_delete' ) ?></a>
											<===> 
											<a href="plugin.php?page=Tasks/task_cat_edit.php&edit_id=<?php echo $row["taskcat_id"]; ?>"><?php echo lang_get( 'task_edit' ) ?></a><br>
											</td>
											</tr>
											<?php
							}	 
